...
alias tsd="phpunit --stop-on-failure --order-by=defects"
alias tds="phpunit --stop-on-failure --order-by=defects"
...
alias dusksd="artisan dusk --stop-on-failure --order-by=defects"
alias duskds="artisan dusk --stop-on-failure --order-by=defects"
